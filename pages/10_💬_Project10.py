...
project_path = ROOT / "Project10"
app_file = project_path / "app.py"

if not app_file.exists():
    st.error(f"""
    ❌ Project file not found: `Project10/app.py`
...
try:
    ...
    spec = importlib.util.spec_from_file_location("project10_app_module", app_file)
    ...
    st.error(f"""
    ❌ Could not import `Project10/app.py`
    
    **Error:** {e}
    
    **Checklist:**
    - [ ] Does `Project10/app.py` exist?
