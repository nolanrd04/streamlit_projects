...
project_path = ROOT / "Project2"
app_file = project_path / "app.py"

if not app_file.exists():
    st.error(f"""
    ❌ Project file not found: `Project2/app.py`
...
try:
    ...
    spec = importlib.util.spec_from_file_location("project2_app_module", app_file)
    ...
    st.error(f"""
    ❌ Could not import `Project2/app.py`
    
    **Error:** {e}
    
    **Checklist:**
    - [ ] Does `Project2/app.py` exist?
