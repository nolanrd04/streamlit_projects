...
project_path = ROOT / "Project4"
app_file = project_path / "app.py"

if not app_file.exists():
    st.error(f"""
    ❌ Project file not found: `Project4/app.py`
...
try:
    ...
    spec = importlib.util.spec_from_file_location("project4_app_module", app_file)
    ...
    st.error(f"""
    ❌ Could not import `Project4/app.py`
    
    **Error:** {e}
    
    **Checklist:**
    - [ ] Does `Project4/app.py` exist?
