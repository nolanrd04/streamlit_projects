...
project_path = ROOT / "Project1"
app_file = project_path / "app.py"

if not app_file.exists():
    st.error(f"""
    ❌ Project file not found: `Project1/app.py`
...
try:
    ...
    spec = importlib.util.spec_from_file_location("project1_app_module", app_file)
    ...
    st.error(f"""
    ❌ Could not import `Project1/app.py`
    
    **Error:** {e}
    
    **Checklist:**
    - [ ] Does `Project1/app.py` exist?
