...
project_path = ROOT / "Project8"
app_file = project_path / "app.py"

if not app_file.exists():
    st.error(f"""
    ❌ Project file not found: `Project8/app.py`
...
try:
    ...
    spec = importlib.util.spec_from_file_location("project8_app_module", app_file)
    ...
    st.error(f"""
    ❌ Could not import `Project8/app.py`
    
    **Error:** {e}
    
    **Checklist:**
    - [ ] Does `Project8/app.py` exist?
