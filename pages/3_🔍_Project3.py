...
project_path = ROOT / "Project3"
app_file = project_path / "app.py"

if not app_file.exists():
    st.error(f"""
    ❌ Project file not found: `Project3/app.py`
...
try:
    ...
    spec = importlib.util.spec_from_file_location("project3_app_module", app_file)
    ...
    st.error(f"""
    ❌ Could not import `Project3/app.py`
    
    **Error:** {e}
    
    **Checklist:**
    - [ ] Does `Project3/app.py` exist?
