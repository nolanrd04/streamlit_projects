...
project_path = ROOT / "Project7"
app_file = project_path / "app.py"

if not app_file.exists():
    st.error(f"""
    ❌ Project file not found: `Project7/app.py`
...
try:
    ...
    spec = importlib.util.spec_from_file_location("project7_app_module", app_file)
    ...
    st.error(f"""
    ❌ Could not import `Project7/app.py`
    
    **Error:** {e}
    
    **Checklist:**
    - [ ] Does `Project7/app.py` exist?
