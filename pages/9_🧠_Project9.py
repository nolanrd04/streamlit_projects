...
project_path = ROOT / "Project9"
app_file = project_path / "app.py"

if not app_file.exists():
    st.error(f"""
    ❌ Project file not found: `Project9/app.py`
...
try:
    ...
    spec = importlib.util.spec_from_file_location("project9_app_module", app_file)
    ...
    st.error(f"""
    ❌ Could not import `Project9/app.py`
    
    **Error:** {e}
    
    **Checklist:**
    - [ ] Does `Project9/app.py` exist?
