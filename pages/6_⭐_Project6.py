"""
Project6 - Recommendation System
...
project_path = ROOT / "Project6"
app_file = project_path / "app.py"

if not app_file.exists():
    st.error(f"""
    ❌ Project file not found: `Project6/app.py`
...
try:
    ...
    spec = importlib.util.spec_from_file_location("project6_app_module", app_file)
    ...
    st.error(f"""
    ❌ Could not import `Project6/app.py`
    
    **Error:** {e}
    
    **Checklist:**
    - [ ] Does `Project6/app.py` exist?
