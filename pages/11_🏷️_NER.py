...
project_path = ROOT / "NER"
app_file = project_path / "app.py"

if not app_file.exists():
    st.error(f"""
    ❌ Project file not found: `NER/app.py`
...
try:
    ...
    spec = importlib.util.spec_from_file_location("ner_app_module", app_file)
    ...
    st.error(f"""
    ❌ Could not import `NER/app.py`
    
    **Error:** {e}
    
    **Checklist:**
    - [ ] Does `NER/app.py` exist?
